...
-export([make_io/1]).
-export([extract_query_arg_value_as_str/3]).
...
extract_query_arg_value_as_str([],_Arg_name,Default_value)->
    Default_value;
extract_query_arg_value_as_str([H|T],Arg_name,Default_value)->
    case element(1,H) of
        Arg_name -> element(2,H);
        _ -> extract_query_arg_value_as_str(T,Arg_name,Default_value)
    end.
